...
file_sql_to_load = LoadDataSancoes(name_folder_inserts="cnep")
path_file = file_sql_to_load.get_file_datas()
with open(path_file, "r") as sql_file:
        sql_query = sql_file.read()


with DAG(dag_id="pipeline_etl_cnep",
    ...
    extract_task = PythonOperator(
        task_id="extract_cnep_data",
        python_callable=extract_data
    )

    transform_task = PythonOperator(
        task_id="transform_cnep_data",
